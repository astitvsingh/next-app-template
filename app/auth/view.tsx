          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 mb-12 md:mb-0">
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-8">
                ...
                ecosystem. Whether you're barking out helpful advice, organizing
                engaging events, sharing insightful content, or lending a
                helping paw to fellow community members, your contributions
                won't go unnoticed!
              </p>
              <Link
